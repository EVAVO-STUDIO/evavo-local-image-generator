...
CRITICAL_FILES: Sequence[str] = (
    ...
    "repair-comfyui-dependencies.py",
    "agent-doctor.py",
    "legacy_image_cli.py",
    "claude_control.py",
    "EVAVO-GATEWAY.py",
    ...
    "evavo_local_image_generator/comfyui_repair.py",
    ...
    "evavo_local_image_generator/comfyui_app.py",
    "evavo_local_image_generator/local_app.py",
    ...
    "AGENT-RECOVERY.md",
    "COMFYUI-STARTUP-DIAGNOSTICS.md",
    "AUTOMATION-GUIDE.md",
